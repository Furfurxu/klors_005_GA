...
#define AD9959_SDIO2_GPIO 	GPIOG
#define AD9959_SDIO3_GPIO 	GPIOA
#define AD9959_PS0_GPIO 		GPIOA
#define AD9959_PS1_GPIO 		GPIOG
#define AD9959_PS2_GPIO 		GPIOB
#define AD9959_PS3_GPIO 		GPIOC
#define AD9959_SCLK_GPIO 		GPIOG
#define AD9959_CS_GPIO 			GPIOA
#define AD9959_UPDATE_GPIO 	GPIOG
#define AD9959_RESET_GPIO 	GPIOG
#define AD9959_PDC_GPIO 		GPIOG

#define AD9959_SDIO0_Pin 	GPIO_PIN_5
#define AD9959_SDIO1_Pin 	GPIO_PIN_4
#define AD9959_SDIO2_Pin 	GPIO_PIN_3
...
#define AD9959_UPDATE_Pin 	GPIO_PIN_9
#define AD9959_RESET_Pin 	GPIO_PIN_5
#define AD9959_PDC_Pin 		GPIO_PIN_4
